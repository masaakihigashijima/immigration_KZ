...
$featurearray = array("Education" => array("No formal education","Equivalent to completing lower secondary school in Kazakhstan","Equivalent to completing an initial training school in Kazakhstan","Equivalent to completing a lycee in Kazakhstan","Equivalent to completing a college in Kazakhstan","Equivalent to completing a backelor in Kazakhstan","Equivalent to completing a master degree in Kazakhstan"),"Gender" => array("Female","Male"),"Ethnicity" => array("Kazakh","Kyrgyz","Uzbek","Tatar","Uighur","Korean","Chinese","Slavic/German"),"Language" => array("He/she speaks both Kazakh and Russian fluently","He/she speaks fluent Kazakh and speaks broken Russian","He/she speaks fluent Kazakh and does not speak Russian","He/she speaks fluent Russian and speaks broken Kazakh","He/she speaks fluent Russian and does not speak Kazakh","He/she speaks broken Kazakh and broken Russian","He/she speaks broken Kazakh and does not speak Russian","He/she speaks broken Russian and does not speak Kazakh","He does not speak both Kazakh and Russian"),"Application Reason" => array("Reunite with family members and relatives in Kazakhstan","Seek a better job in Kazakhstan","Escape political/religious persecution"),"Profession" => array("Gardener","Waiter","Nurse","Teacher","Child care provider","Janitor","Construction worker","Financial analyst","Research scientist","Doctor","Computer programmer "),"Job experience" => array("No job training or prior experience","One to two years","Three to five years","More than five years"),"Religion" => array("Muslim (Non-practicing)","Muslim (Devout)","Muslim (Radical)","Christian (Non-practicing)","Christian (Devout)","Christian (Radical)","Buddhism","Judaist","Tengri","No religion"));
